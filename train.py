...
INPUT_PATH = os.path.join(ROOT_PATH, "data", company_code)
OUTPUT_PATH = os.path.join(ROOT_PATH, "data", iter_changes)
...
params = {'batch_size': 60, 'conv2d_layers': {'conv2d_do_1': 0.0, 'conv2d_filters_1': 30,
           ...
           'epochs': 50, 'lr': 0.001, 'optimizer': 'adam', 'input_dim_1': 15, 'input_dim_2': 15, 'input_dim_3': 3}
